...
IMAGE_GENERATION_NEGATIVE_PROMPT = os.getenv("IMAGE_GENERATION_NEGATIVE_PROMPT", "")

IMAGE_CFG = int(os.getenv("IMAGE_CFG", "7"))
AUTOMATIC1111_SAMPLING_METHOD = os.getenv("AUTOMATIC1111_SAMPLING_METHOD", "Euler")
AUTOMATIC1111_RESTORE_FACE = (
    os.environ.get("AUTOMATIC1111_RESTORE_FACE", "").lower() == "true"
)
